...
export ZINC_LDFLAGS="-w -s -X github.com/zincsearch/zincsearch/pkg/meta.Version=${VERSION} -X github.com/zincsearch/zincsearch/pkg/meta.BuildDate=${BUILD_DATE} -X github.com/zincsearch/zincsearch/pkg/meta.CommitHash=${COMMIT_HASH}"
...
go build -ldflags="$ZINC_LDFLAGS" -o zincsearch cmd/zincsearch/main.go
